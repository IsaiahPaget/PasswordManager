...
<template>
  <div class="loading-container spinner-fade-in">
    <div class="loading">
...
.loader {
  ...
  font-weight: bold;
  background: 
    linear-gradient(var(--color-fg-3) 0 0) left,
    linear-gradient(var(--color-fg-3) 0 0) right;
...
.loader::after {
  ...
  height: 60px;
  background: 
   linear-gradient(90deg,var(--color-fg-2) 4px,#0000 0 calc(100% - 4px),var(--color-fg-2) 0) bottom            /22px 20px,
   linear-gradient(90deg, var(--color-red)  4px,#0000 0 calc(100% - 4px), var(--color-red)  0) bottom 10px left 0/22px 6px,
   linear-gradient(var(--color-fg-2) 0 0) bottom 3px left 0  /22px 8px,
   linear-gradient(var(--color-fg-2) 0 0) bottom 0   left 50%/8px  16px;
 background-repeat: no-repeat;
